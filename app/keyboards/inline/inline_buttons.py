...
from app.data import to_eng

from app.keyboards.inline import day_week_inline, other_week_inline, teacher_inline, delete_teacher_rating
from app.models import ThisNextWeek, Week
