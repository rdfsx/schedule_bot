...
from app.data import faculties, ERROR
from app.data import hello_message
...
from app.utils.db_api.commands.coomands_group import select_all_groups, select_group, select_group_id
