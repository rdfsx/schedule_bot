...
from app.data import faculties, ERROR, PREPODS, sticker
...
from app.utils.db_api.commands import select_all_teachers, set_rating, select_teacher_id, delete_rating
from app.utils.db_api.commands.coomands_group import select_all_groups, select_group_id
from app.utils import User
from app.utils.db_api.commands import get_some_day
